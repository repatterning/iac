...
aws logs create-log-group --cli-input-json "$path/variational/ecs/logs/define.json"
aws logs create-log-group --cli-input-json "$path/viability/ecs/logs/define.json"
...
aws ecs register-task-definition --cli-input-json "$path/variational/ecs/tasks/define.json"
aws ecs register-task-definition --cli-input-json "$path/viability/ecs/tasks/define.json"
